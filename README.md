...
|------|---------|------------|
| Software Engineer | Fastr | Built full-stack dashboards (ClojureScript + gRPC/SQL), improved analytics speed 35%, reduced outages 40%, automated CI/CD |
| Software Engineer | Cvent India | Developed React + Next.js interfaces, built Java Dropwizard services for 50k+ users, optimized backend queries 40% |
